...
func (h *Handler) OAuthLogin(c *fiber.Ctx) error {
	...
	url := fmt.Sprintf("https://www.facebook.com/v19.0/dialog/oauth?client_id=%s&redirect_uri=%s&state=%s&scope=pages_show_list,pages_messaging,pages_manage_metadata,pages_read_engagement&response_type=code&auth_type=rerequest",
