        ...
        <div className="glass-card p-8 border-white/10 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-center mb-10">
              ...
              <h1 className="text-3xl font-heading font-black text-white tracking-tight">{t('auth.register_title')}</h1>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input type="text" value={form.full_name} onChange={e => setForm({...form, full_name: e.target.value})} placeholder="John Doe" className="input-field pl-11 bg-white/5 border-white/10 focus:bg-white/10" required autoComplete="name" />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input type="email" value={form.email} onChange={e => setForm({...form, email: e.target.value})} placeholder="email@example.com" className="input-field pl-11 bg-white/5 border-white/10 focus:bg-white/10" required autoComplete="email" />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input type="password" value={form.password} onChange={e => setForm({...form, password: e.target.value})} placeholder="••••••••" className="input-field pl-11 bg-white/5 border-white/10 focus:bg-white/10" required minLength={8} autoComplete="new-password" />
                </div>
              </div>
