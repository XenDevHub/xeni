        ...
        <div className="glass-card p-8">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="relative">
              ...
              <input type="text" value={form.full_name} onChange={e => setForm({...form, full_name: e.target.value})} placeholder={t('auth.full_name')} className="input-field pl-10" required autoComplete="name" />
            </div>
            <div className="relative">
              <Mail className="absolute left-3 top-3.5 w-5 h-5 text-dark-500" />
              <input type="email" value={form.email} onChange={e => setForm({...form, email: e.target.value})} placeholder={t('auth.email')} className="input-field pl-10" required autoComplete="email" />
            </div>
            <div className="relative">
              <Lock className="absolute left-3 top-3.5 w-5 h-5 text-dark-500" />
              <input type="password" value={form.password} onChange={e => setForm({...form, password: e.target.value})} placeholder={t('auth.password')} className="input-field pl-10" required minLength={8} autoComplete="new-password" />
            </div>
